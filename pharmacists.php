...
<div class="ui modal edit mini" id="editmodal">
  ...
  <div class="header">
   <h3><i class="edit icon"></i> Modifier le dossier du pharmacien</h3>
  </div>
  <div class="content">
<form class="ui form">

<input type="hidden" id="id">
<input type="hidden" id="job" value="Pharmacien">
<input type="hidden" id="sealto" value="">
<input type="hidden" id="signatureto" value="">
...
<div class="ui modal print" id="printmodal">
  <i class="close icon"></i>
  <div class="header">
   <h3><i class="print icon"></i> Imprimer la carte sanitaire du pharmacien</h3>
  </div>
  <div class="content" id="printable" style="text-align: center;">
    ...
    <div style="border: 2.5px solid black; width: 75%; border-style: dashed;">
      ...
      <h3 style="margin-top: -5px !important;">Carte sanitaire du pharmacien</h3>
...
<input type="hidden" name="job" value="Pharmacien">
<input type="hidden" name="seal" value="">
<input type="hidden" name="signature" value="">
<input type="hidden" name="description" value="">
<input type="hidden" name="from" value="pharmacists">
...
<a class="ui green tag label">Les pharmaciens</a>
</div>
...
<div class="ui negative message">
    <p>Vous pouvez 'Activer/ Désactiver' le compte du pharmacien en double-cliquant sur le 'statut'.</p>
</div>
...
<div class="ui negative message">
    <p>Les dossiers des pharmaciens supprimés seront définitivement supprimés après 30 jours.</p>
</div>
...
$('#printprofession').html("Profession: Pharmacien");
