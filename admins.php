...
<div class="ui modal edit mini" id="editmodal">
  ...
  <div class="header">
   <h3><i class="edit icon"></i> Modifier le dossier de l'administrateur</h3>
  </div>
  <div class="content">
<form class="ui form">

<input type="hidden" id="id">
<input type="hidden" id="job" value="Admin">
...
<div class="ui modal print" id="printmodal">
  <i class="close icon"></i>
  <div class="header">
   <h3><i class="print icon"></i> Imprimer la carte sanitaire de l'administrateur</h3>
  </div>
  <div class="content" id="printable" style="text-align: center;">
    ...
    <div style="border: 2.5px solid black; width: 75%; border-style: dashed;">
      ...
      <h3 style="margin-top: -5px !important;">Carte sanitaire de l'administrateur</h3>
...
<a class="ui green tag label">Les administrateurs</a>
</div>
...
$('#printprofession').html("Profession: Admin");
